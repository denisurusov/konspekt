...
Pre–first-external-adopter. Schema and serialization are at **v1**. The format is being refined by dogfooding (see `instance/`); the next milestone is a second, independent implementer.
